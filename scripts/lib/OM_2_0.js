var OM_2_0_Module_Factory = function () {
  var OM_2_0 = {
    ...
    deps: ['GML_3_2', 'XLink_1_0', 'ISO19139_GMD_20070417'],
    tis: [{
        ...
        ln: 'OtherAbstractTimeObjectType',
        bti: 'GML_3_2.AbstractTimeObjectType'
      }, {
        ...
        ps: [{
            ...
            ti: 'GML_3_2.AbstractTimeObjectType',
            t: 'er'
          }, {
            n: 'nilReason',
            ti: {
        ...
        ps: [{
            ...
            n: 'resultTime',
            rq: true,
            ti: 'GML_3_2.TimeInstantPropertyType'
          }, {
            n: 'validTime',
    ...
    eis: [{
        ...
        en: 'OtherAbstractTimeObject',
        ti: '.OtherAbstractTimeObjectType',
        sh: {
          lp: 'AbstractTimeObject',
          ns: 'http:\/\/www.opengis.net\/gml\/3.2'
        }
